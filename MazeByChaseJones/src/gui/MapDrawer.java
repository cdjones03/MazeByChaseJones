...
public class MapDrawer {
	...
	private void drawMap(MazePanel panel, int px, int py, int walkStep, 
		...
		for (int y = minY; y <= maxY; y++)
			for (int x = minX; x <= maxX; x++) {
				...
				panel.setColor(seenCells.hasWall(x,y, CardinalDirection.North) ? MazePanel.getColorWhite() : MazePanel.getColorGrey());
				...
				if(seenCells.hasWall(x,y, CardinalDirection.West))
					...
					panel.setColor(MazePanel.getColorGrey());
	...
	private void drawCurrentLocation(MazePanel panel, int viewDX, int viewDY) {
		panel.setColor(MazePanel.getColorRed());
	...
	private void drawSolution(MazePanel panel, int offsetX, int offsetY, int px, int py) {
		...
		panel.setColor(MazePanel.getColorYellow());
